var startingLine,
	...
	mbta = {
		...
		distance_to_park: function(line) {
			var current_line = mbta.lines[line], park = current_line.indexOf('park st');
...
start_parkst = mbta.distance_to_park(startingLine);
end_parkst = mbta.distance_to_park(endingLine);
